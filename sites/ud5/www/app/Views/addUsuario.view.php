                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <p class="text-danger"><?php echo isset($errores['errores']['username'])?></p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                ...
                                <p class="text-danger"><?php echo isset($errores['errores']['periodo'])?></p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-3">
                            <div class="form-group">
                                <label for="salarioBruto">Salario Bruto:</label>
                                        ...
                                        />
                                <p class="text-danger"><?php echo isset($errores['errores']['salarioBruto'])?></p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-3">
                            <div class="form-group">
                                <label for="cotizacion">Cotización:</label>
                                        ...
                                        />
                                <p class="text-danger"><?php echo isset($errores['errores']['cotizacion'])?></p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-3">
                            <div class="form-group">
                                ...
                                <p class="text-danger"><?php echo isset($errores['errores']['id_country'])?></p>
                            </div>
                        </div>
                        <div class="col-12 col-lg-3">
                            <div class="form-group">
