<!-- Sidebar Menu -->
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item <?php echo (in_array($_SERVER['REQUEST_URI'], [$_ENV['host.folder'] . 'demo-proveedores', [$_ENV['host.folder'] . 'proveedores']])) ? 'menu-open' : '';?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="<?php echo $_ENV['host.folder'] ?>proveedores" class="nav-link <?php echo $_SERVER['REQUEST_URI'] === $_ENV['host.folder'] . 'proveedores' ? 'active' : ''; ?>">
                        <i class="fas fa-laptop-code nav-icon"></i>
                        <p>Proveedores</p>
                    </a>
                </li>
