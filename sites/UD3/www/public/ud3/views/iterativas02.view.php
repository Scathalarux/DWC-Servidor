...
<?php if (isset($data['num_ordenados'])) { ?>
    <div class="row">
        <div class="col-12">
            <div class="alert alert-success">
                <p>Conjunto ordenado: <?php echo $data['num_ordenados']; ?></p>
            </div>
        </div>
    </div>
    <?php
    ...
    <div class="col-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Ordenación de un conjunto de números</h6>
            </div>
            <div class="card-body">
